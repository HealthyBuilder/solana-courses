...
const collectionAddress = UMIPublicKey("6vBUkHCh99cdLdmZ6i9WYKTdBpJLnjAvtFUB21BdFKNG");

// Substitute in your NFT address from create-metaplex-nft.ts
const nftAddress = UMIPublicKey("GhoptN8PQaedJSwFYjQVKTFvgSvJNtxdpHAwz9BXzYaz");
